...
<link href="{{ asset('css/sales_manager/media_documents.css') }}" rel="stylesheet" />
    ...
    <div class="row g-4 d-flex justify-content-between">
        ...
        <div class="col-md-5 float-right mt-2 mt-md-0">
            <div class="search-container mb-5">
                <form action="{{ url('sale_manager/media_documents') }}" method="GET" class="d-flex align-items-center">
                    ...
                    <button type="submit" class="btn btn-primary search-btn custom_search">Search</button>
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-5 col-lg-3">
                <div class="card document-card shadow-sm border-0 text-center p-3">
                    ...
                    <div class="icon-container mb-3 mx-auto">
                        ...
                        <iframe src="{{ asset('sales_manager/media_database/documents/' . $Document->name) }}" width="100%" height="200px"></iframe>

                        {{-- Preview Office files (Word, Excel) --}}
                        @elseif(in_array(strtolower($fileExtension), ['doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx']))
                        <iframe src="https://view.officeapps.live.com/op/embed.aspx?src={{ urlencode(asset('sales_manager/media_database/documents/' . $Document->name)) }}" width="100%" height="200px"></iframe>
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        ...
                        <a href="{{ asset('sales_manager/media_database/documents/' . $Document->name) }}" class="btn btn-secondary btn-sm w-50" target="_blank">
                            <i class="bi bi-eye"></i> View
                        </a>
                        @endif
                        <a href="{{ asset('sales_manager/media_database/documents/' . $Document->name) }}" class="btn btn-primary btn-sm w-50" download>
