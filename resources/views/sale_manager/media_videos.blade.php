...
<link href="{{ asset('css/sales_manager/media_videos.css') }}" rel="stylesheet" />
    ...
    <div class="row g-4 d-flex justify-content-between">
        ...
        <div class="col-md-5 float-right mt-2 mt-md-0">
            <div class="search-container mb-5">
                <form action="{{ url('sale_manager/media_videos') }}" method="GET" class="d-flex align-items-center">
            ...
            <div class="col-md-5 col-lg-4 col-sm-6 col-xl-3">
                <div class="card document-card shadow-sm border-0 text-center p-3">
                    ...
                    <h5 class="card-title text-dark fw-bold mb-3">
                        {{ \Illuminate\Support\Str::limit(pathinfo($Video->name, PATHINFO_FILENAME), 20, '...') }}
                        .{{ pathinfo($Video->name, PATHINFO_EXTENSION) }}
                    </h5>
                    <!-- Buttons -->
                    <div class="d-flex justify-content-center gap-3">
                        <a href="{{ asset('sales_manager/media_database/videos/' . $Video->name) }}" class="btn btn-secondary btn-sm w-50" target="_blank">
                            <i class="bi bi-eye"></i> View
                        </a>
                        <a href="{{ asset('sales_manager/media_database/videos/' . $Video->name) }}" class="btn btn-primary btn-sm w-50" download>
