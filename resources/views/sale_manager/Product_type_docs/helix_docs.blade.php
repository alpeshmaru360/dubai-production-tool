    ...
    <div class="row g-4 d-flex justify-content-between">
        ...
        <div class="col-md-5 float-right">
            <div class="search-container mb-5">
                <form action="{{ url('sale_manager/helix_docs') }}" method="GET" class="d-flex align-items-center">
            ...
            <div class="col-md-5 col-lg-3">
                <div class="card document-card shadow-sm border-0 text-center p-3">
                    ...
                    <div class="icon-container mb-3 mx-auto">
                        ...
                        <iframe src="{{ asset('sales_manager/document_portal/product_types/helix_docs/' . $document->name) }}" width="100%" height="200px"></iframe>
                        ...
                        <video autoplay muted loop src="{{ asset('sales_manager/document_portal/product_types/helix_docs/' . $document->name) }}" alt="{{ $document->name }}" class="img-preview">
                            ...
                            {{ file_get_contents(public_path('sales_manager/document_portal/product_types/helix_docs/'. $document->name)) }}
                            </pre>

                            {{-- Preview Office files (Word, Excel) --}}
                            @elseif(in_array(strtolower($fileExtension), ['doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx']))
                            <iframe src="https://view.officeapps.live.com/op/embed.aspx?src={{ urlencode(asset('sales_manager/document_portal/product_types/helix_docs/' . $document->name)) }}" width="100%" height="200px"></iframe>
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        ...
                        <a href="{{ asset('sales_manager/document_portal/product_types/helix_docs/' . $document->name) }}" class="btn btn-secondary btn-sm w-50" target="_blank">
                            <i class="bi bi-eye"></i> View
                        </a>
                        @endif

                        {{-- Download button always available --}}
                        <a href="{{ asset('sales_manager/document_portal/product_types/helix_docs/' . $document->name) }}" class="btn btn-primary btn-sm w-50" download>
