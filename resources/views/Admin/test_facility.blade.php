...
<link href="{{ asset('css/Admin/test_facility.css') }}" rel="stylesheet" />
...
<section class="p-4">
    ...
    @endif
    <div class="heading">Test Facility</div>
    ...
    <div class="tab-content mt-3" id="productionToolTabsContent">
        ...
        <div class="tab-pane fade show active" id="banner" role="tabpanel" aria-labelledby="banner-tab">
            ...
            <form action="{{ route('admin.updateBannerImage1') }}" method="POST" enctype="multipart/form-data">
                @csrf
        ...
        <div class="tab-pane fade" id="location" role="tabpanel" aria-labelledby="location-tab">
            ...
            <form action="{{ route('admin.updateLocation1') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <img src="{{ asset('sales_manager/images/' . $currentLocationImage) }}" alt="" class="w-75 mx-auto">
                @else
        ...
        <div class="tab-pane fade" id="pumpTesting" role="tabpanel" aria-labelledby="pumpTesting-tab">
            <form action="{{ route('admin.updatePumpTestingFacility1') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <label for="" class="form-label">Crurrent Testing Facility Image</label>
        ...
        <div class="tab-pane fade" id="ProductRange" role="tabpanel" aria-labelledby="ProductRange-tab">
            <form action="{{ route('admin.updateProductRange1') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <!-- Product Range Heading -->
                <div class="mb-3">
                    <label for="Product_range_button" class="form-label d-block">Product Range Heading<span class="text-danger">*</span></label>
        ...
        <div class="tab-pane fade" id="quality" role="tabpanel" aria-labelledby="Quality-tab">
            <form action="{{ route('admin.updateQuality1') }}" method="POST" enctype="multipart/form-data">
                @csrf
        ...
        <div class="tab-pane fade" id="sustainability" role="tabpanel" aria-labelledby="sustainability-tab">
            <form action="{{ route('admin.updateSustainability1') }}" method="POST" enctype="multipart/form-data">
                @csrf
        ...
        <div class="tab-pane fade" id="team" role="tabpanel" aria-labelledby="team-tab">
            <form action="{{ route('admin.updateTeam1') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <tr data-id="{{ $member->id }}">
                                <td>
                                    <div class="profile-pic-container">
                                        @if(file_exists(public_path('sales_manager/team_test_facility/' . $member->profile_pic)) && !empty($member->profile_pic))
                                        <img src="{{ asset('sales_manager/team_test_facility/' . $member->profile_pic) }}" alt="Profile Pic" class="profile-pic">
                                        @else
                                        <img id="profilePicPreview" src="{{ asset('sales_manager/team_test_facility/default_user.jpg') }}" alt="Profile Picture" class="profile-pic mb-2" height="100" width="100">
                                        @endif
                                    </div>
                                </td>
                                <td>{{ $member->name }}</td>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('about-dubai.store1') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="col-12 mb-3 text-center">
                                            ...
                                            <div class="profile-pic-container">
                                                <img id="profilePicPreview"
                                                    src="{{ asset('sales_manager/team_test_facility/default_user.jpg') }}"
                                                    alt="Profile Picture"
                                ...
                                <form id="editMemberForm" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-3 text-center">
                                            ...
                                            <input type="file" class="form-control mt-2" id="editProfilePicInput" name="profile_pic" style="display: none;" accept="image/jpeg, image/png, image/webp" onchange="previewImage(event, 'editProfilePicPreview')">
                                            <div id="editerrorMessage" class="error-message">Please upload only JPG, PNG, WEBP, or JPEG files. Your current profile picture will not be lost upon saving.</div>
                                        </div>
                                        <div class="col-12 mb-3">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary bg_dark cancel_button" data-dismiss="modal">Cancel</button>
        ...
        <div class="tab-pane fade" id="innovation" role="tabpanel" aria-labelledby="innovation-tab">
            <form action="{{ route('admin.updateInnovation1') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row w-100 mt-4">
                    <div class="w-100 mx-auto text-center d-flex justify-content-between">
                        <div class="success_box">
                            <img src="{{ asset('sales_manager/images/' . $currentSuccessStory_image_1) }}" class="mt-2 success-image" alt="">
                        </div>
                        <div class="success_box">
                            <img src="{{ asset('sales_manager/images/' . $currentSuccessStory_image_2) }}" class="mt-2 success-image" alt="">
                        </div>
                        <div class="success_box">
                            <img src="{{ asset('sales_manager/images/' . $currentSuccessStory_image_3) }}" class="mt-2 success-image" alt="">
                        </div>
                    </div>
                </div>
...
<script>
        ...
        axios.post(action, formData, {
            ...
            .then(response => {
                ...
                if (response.data.success) {
                    ...
                    alert('Error updating member: ' + response.data.message);
                }
            })
            .catch(error => {
    ...
    function fetchMember(id) {
        ...
        axios.get(`${baseUrl}/admin/about-dubai1/${id}/edit1`)
            .then(response => {
                ...
                if (data.profile_pic) {
                    ...
                    const imageUrl = `${baseUrl}/public/sales_manager/team_test_facility/${data.profile_pic}`;
                ...
                document.getElementById('editMemberForm').action = `${baseUrl}/admin/about-dubai1/${id}`;
            })
            .catch(error => {
                console.error('Error:', error.response ? error.response.data : error.message);
                alert('Failed to fetch member data. Please check the console for more details.');
            });
    }
    ...
    function confirmDelete(id) {
        ...
        form.action = `${window.location.origin}/admin/about-dubai1/${id}`;
        modal.show();
    }
        ...
        axios.delete(form.action)
            .then(response => {
                if (response.data.success) {
                    ...
                    alert('Error deleting member: ' + response.data.message);
                }
            })
            .catch(error => {
                console.error('Error:', error);
...
<script>
    ...
    function saveOrder(order) {
        $.ajax({
            url: 'setTestFacilityOrder', // Your route to handle the order saving
            method: 'POST',
            data: {
                order: order,
