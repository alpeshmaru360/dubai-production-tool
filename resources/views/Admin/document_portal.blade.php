...
<section class="px-4">
    ...
    <div class="folder-container">
        ...
        <div class="folder">
            <a href="{{route('GenralDocument')}}">
                <svg xmlns="http://www.w3.org/2000/svg" class="folder-icon" viewBox="0 0 24 24" fill="none"
        ...
        <!-- Product Types Documents Folder -->
        <div class="folder">
            <a href="{{route('ProductDocument')}}">
                <svg xmlns="http://www.w3.org/2000/svg" class="folder-icon" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    style="color: #169e88;">
                    <path d="M3 7h18a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2z"></path>
...
<div class="dubai_production_section">
    <a href="{{route('AdminDashboard')}}" class="btn btn-primary custom-add"><svg xmlns="http://www.w3.org/2000/svg" class="back-svg" viewBox="0 0 448 512">
