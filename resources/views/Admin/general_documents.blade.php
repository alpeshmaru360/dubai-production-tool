...
<section class="p-3 d-flex justify-content-between">
    <div>
        <a href="{{ route('DocumentPortal') }}" class="btn btn-primary custom-add">
        ...
        <table class="table table-bordered table-hover table-striped" id="document-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="document_preview" style="width:32%">
                        @php
                        ...
                        @elseif(in_array($fileExtension, ['doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'ods', 'odt', 'odp']))
                            ...
                            <!-- <iframe src="https://view.officeapps.live.com/op/embed.aspx?src={{ urlencode(asset('sales_manager/document_portal/general_documents/' . $document->name)) }}" width="100%" height="100px" style="overflow: scroll;"></iframe> -->
                        ...
                        @elseif(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'tiff', 'webp']))
                            <img src="{{ $documentPath }}" alt="{{ $document->name }}" class="img-preview" style="max-width: 100%; height: auto;">
                        ...
                        @elseif(in_array($fileExtension, ['txt', 'csv', 'log', 'xml', 'json', 'md']))
                            <pre style="width: 100%; height: 200px; overflow: auto; border: 1px solid #ccc; padding: 10px;">
                    ...
                    <td>
                        <div class="action-buttons">
                            ...
                            <a href="{{ asset('sales_manager/document_portal/general_documents/' . $document->name) }}" target="_blank" class="action-button" title="View">
                            ...
                            <a href="{{ asset('sales_manager/document_portal/general_documents/' . $document->name) }}" class="action-button" download title="Download">
                            ...
                            <form action="{{ route('GeneralDocument.destroy', $document->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
...
<div class="modal fade" id="fileUploadModal" tabindex="-1" aria-labelledby="fileUploadModalLabel" aria-hidden="true">
    <form action="{{ route('GenralDocument.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
...
<div class="modal fade" id="deleteConfirmModal" tabindex="-1" aria-labelledby="deleteConfirmModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteConfirmModalLabel">Confirm Deletaion</h5>
            </div>
            <div class="modal-body">
...
<script src="{{ asset('js/Admin/general_documents1.js') }}"></script>
