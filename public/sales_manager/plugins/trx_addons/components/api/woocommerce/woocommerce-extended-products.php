...
if ( ! function_exists( 'trx_addons_sc_extended_products' ) ) {
	...
	function trx_addons_sc_extended_products( $atts, $content = null ) {	
		...
		$atts['columns'] = max( 2, min( $atts['per_page'], (int)$atts['columns'] ) );
		if ( ! empty( $atts['columns_tablet'] ) ) $atts['columns_tablet'] = max( 2, min( $atts['per_page'], (int)$atts['columns_tablet'] ) );
		if ( ! empty( $atts['columns_mobile'] ) ) $atts['columns_mobile'] = max( 2, min( $atts['per_page'], (int)$atts['columns_mobile'] ) );
