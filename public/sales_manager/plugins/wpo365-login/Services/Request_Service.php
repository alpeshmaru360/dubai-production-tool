    ...
    class Request_Service
    {
        ...
        public static function shutdown()
        {
            ...
            if (!empty($wpo_usr)) {
                ...
                User_Service::save_user_first_name($wpo_usr->first_name);
                User_Service::save_user_last_name($wpo_usr->last_name);
                User_Service::save_user_full_name($wpo_usr->full_name);
